   ...
   stage('Check code coverage') {
            steps {
                script {
                    ...
                    def componentKey = "com.support:restaurantlisting"
      ...
      steps {
          ...
          sh 'docker build -t msdevcoder123/restaurant-service:${VERSION} .'
          sh 'docker push msdevcoder123/restaurant-service:${VERSION}'
      }
    } 
